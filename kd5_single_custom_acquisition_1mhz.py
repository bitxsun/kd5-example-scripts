...
pulse_cycle = 5
pulse_volt = 5 # 5V (10Vpp) is the maximum output voltage
centre_freq = 1e6
sample_freq = 50e6
velocity = 1500;
...
pulse_sample_freq = 100e6 # Frequency of the output DAC, 10e6 is the Maximum Limit
...
centre_time = 1 * (pulse_cycle / centre_freq)
...
plt.plot(dist_axis*1e3, data_fltr, color = 'blue', linestyle = "-", label = 'Filtered Data')
plt.ylim([-2, 2])
# plt.legend()
